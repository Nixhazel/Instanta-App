...
import { createComponent } from "../../api/admin";
...
const NewComponents = () => {
	...
	const handleSubmit = async (e: any) => {
		...
		const createComponentResponce: any = await createComponent(componentData);

		// console.log("createComponentResponce", createComponentResponce);

		if (createComponentResponce.status == 200) {
			...
			<div className=' z-30 flex justify-center h-screen w-full bg-gray-700 bg-opacity-50 fixed'>
				<div className=' flex flex-col h-screen  items-center rounded-md w-[75%] bg-white'>
					<div className='flex relative items-center w-[95%] mt-10 px-3 justify-between '>
						<h1 className='text-lg font-bold'>New Component</h1>
